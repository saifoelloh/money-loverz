      ...
      var table = $('#data-table').DataTable({
        ...
        columns: [
          ...
          { data: 'total_items', name: 'total_items' },
          {
            ...
            render: function(data) {
              const detail = `
                <a class="btn btn-warning btn-sm btn-icon" href="{{ route("package.index") }}/${data}/edit">
                  <span class="btn-inner--icon"><i class="fas fa-edit fa-lg"></i></span>
                  <span class="btn-inner--text">edit</span>
                </a>`
              const destroy = `<form action="{{ route("package.index") }}/${data}" method="POST" class="d-inline">
                @method("DELETE")
                @csrf
