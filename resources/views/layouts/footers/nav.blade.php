<div class="row row-grid align-items-center mb-5">
    ...
    <h4 class="mb-0 font-weight-light btn btn-success">Hubungi admin (Whatsapp)</h4>
    </div>
...
<div class="row align-items-center justify-content-xl-between">
    <div class="col-xl-6">
        <div class="copyright text-center text-xl-left text-muted">
            &copy; {{ now()->year }} <a href="#" class="font-weight-bold ml-1" target="_blank">Satupintu</a>
        </div>
    </div>
    <div class="col-xl-6">
        <ul class="nav nav-footer justify-content-center justify-content-xl-end">
            <li class="nav-item">
                <a href="#paket" class="nav-link">Daftar Paket</a>
            </li>
            <li class="nav-item">
                <a href="#katalog" class="nav-link">Katalog Menu</a>
            </li>
            <li class="nav-item ml-2">
                <a href="#" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal-form"><span class="fa fa-shopping-cart"></span>&nbsp; Buat pesanan</a>
            </li>
        </ul>
    </div>
</div>